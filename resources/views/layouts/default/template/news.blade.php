        ...
        <div class="container">
            <div class="row">
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center wow fadeInUp" data-wow-delay="0.3s"> 
                ...
                <h2 class="h2-heading black-color">NEWSROOM</h2>
                <p class="col-lg-8 col-md-8 col-md-offset-2 para-txt black-color mb50">Latest Tech updates.</p>
              </div>
              @php
                  $blog_news = DB::table('dit_blocg_news')->where('status',1)->where('extra1','news')->orderBy('id','DESC')->get();
              @endphp
                          ...
                          <div class="col-eq-ht"> 
                            ...
                            <div class="bg-index-artificial">
                              <div class="news-grid-imgs"> 
                                <img src="{{url('/')}}/uploads/images/news/{{ $row->image }}" class="img-responsive" alt="{{ $row->heading }}"> 
                              </div>
