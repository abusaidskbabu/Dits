...
use App\Models\Ditsportfolios;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class DitsportfoliosController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'ditsportfolios';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Ditsportfolios();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'ditsportfolios',
	...
	public static function display(  )
	{
		...
		$model  = new Ditsportfolios();
		$info = $model::makeInfo('ditsportfolios');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('ditsportfolios.public.view',$data);			
			}			
		} 
		else {
			...
			return view('ditsportfolios.public.index',$data);	
		}
