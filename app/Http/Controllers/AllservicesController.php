...
class AllservicesController extends Controller {
	...
	public $module = 'allservices';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Allservices();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'allservices',
	...
	public static function display(  )
	{
		...
		$model  = new Allservices();
		$info = $model::makeInfo('allservices');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('allservices.public.view',$data);			
			}			
		} 
		else {
			...
			return view('allservices.public.index',$data);	
		}
