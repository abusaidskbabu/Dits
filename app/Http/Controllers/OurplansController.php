...
class OurplansController extends Controller {
	...
	public $module = 'ourplans';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Ourplans();	
	...
	public static function display(  )
	{
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('ourplans.public.view',$data);			
			}			
		} 
		else {
			...
			return view('ourplans.public.index',$data);	
		}
