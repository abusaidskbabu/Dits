...
use App\Models\Howworkdits;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class HowworkditsController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'howworkdits';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Howworkdits();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'howworkdits',
	...
	public static function display(  )
	{
		...
		$model  = new Howworkdits();
		$info = $model::makeInfo('howworkdits');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('howworkdits.public.view',$data);			
			}			
		} 
		else {
			...
			return view('howworkdits.public.index',$data);	
		}
