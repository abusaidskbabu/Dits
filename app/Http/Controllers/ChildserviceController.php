...
class ChildserviceController extends Controller {
	...
	public static function display(  )
	{
		...
		$model  = new Childservice();
		$info = $model::makeInfo('childservice');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('childservice.public.view',$data);			
			}			
		} 
		else {
			...
			return view('childservice.public.index',$data);	
		}
