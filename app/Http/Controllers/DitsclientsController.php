...
use App\Models\Ditsclients;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class DitsclientsController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'ditsclients';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Ditsclients();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'ditsclients',
	...
	public static function display(  )
	{
		...
		$model  = new Ditsclients();
		$info = $model::makeInfo('ditsclients');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('ditsclients.public.view',$data);			
			}			
		} 
		else {
			...
			return view('ditsclients.public.index',$data);	
		}
