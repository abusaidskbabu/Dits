...
use App\Models\Ourtestimonials;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class OurtestimonialsController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'ourtestimonials';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Ourtestimonials();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'ourtestimonials',
	...
	public static function display(  )
	{
		...
		$model  = new Ourtestimonials();
		$info = $model::makeInfo('ourtestimonials');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('ourtestimonials.public.view',$data);			
			}			
		} 
		else {
			...
			return view('ourtestimonials.public.index',$data);	
		}
