...
class OurcompanyController extends Controller {
	...
	public $module = 'ourcompany';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Ourcompany();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'ourcompany',
	...
	public static function display(  )
	{
		...
		$model  = new Ourcompany();
		$info = $model::makeInfo('ourcompany');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('ourcompany.public.view',$data);			
			}			
		} 
		else {
			...
			return view('ourcompany.public.index',$data);	
		}
